...
export default function Login({setPage, onClose}: SignInProps){
      ...
      <div className="min-h-screen w-screen sm:w-sm  flex justify-center items-center">
        <div className="relative w-full h-screen sm:h-fit px-8 py-8 bg-white border rounded-md">
          ...
          <p className="mt-2 text-center text-muted-foreground text-sm">
            Don&apos;t have an account? <button className="cursor-pointer" onClick={() => {setPage('register')}}>Sign Up</button>
          </p>
        </div>
      </div>
    </main>
