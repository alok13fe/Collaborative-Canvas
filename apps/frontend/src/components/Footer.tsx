...
export default function Footer() {
  return (
    <footer className='p-4 w-full absolute bottom-0 left-0 z-1 pointer-events-none'>
      <div className='flex items-start space-x-5'>
        <div className='bg-gray-100 flex items-center space-x-3 pointer-events-auto cursor-pointer shadow-md rounded'>
          <div className='p-2'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 12L18 12" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <div className='text-xs select-none'>100 %</div>
          <div className='p-2'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 12H18M12 6V18" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
        <div className='bg-gray-100 flex items-center space-x-0.5 pointer-events-auto  cursor-pointer shadow-md rounded'>
          <div className='p-2'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
