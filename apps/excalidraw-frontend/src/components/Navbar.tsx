  ...
  return (
    <nav className='p-4 w-full fixed top-0 left-0 pointer-events-none'>
      <div className='flex justify-between items-center'>
        <div className='p-2.5 hover:bg-gray-200 pointer-events-auto border-1 border-gray-200 shadow-md rounded'>
        ...
        <div className='pointer-events-auto'>
          <button className='px-3 py-1.5 flex items-center gap-1 cursor-pointer border-2 rounded'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
